...
namespace CELL
{
    ...
    */
    ...
    public:
        ...
        tmat3x3<T> transpose() const
        {
            tmat3x3<T> out;
            T*  ptr     =   (T*)data();
            T*  outPtr  =   (T*)out.data();

            outPtr[0] = ptr[0];	outPtr[3] = ptr[1];	outPtr[6] = ptr[2];
            outPtr[1] = ptr[3];	outPtr[4] = ptr[4];	outPtr[7] = ptr[5];
            outPtr[2] = ptr[6];	outPtr[5] = ptr[7];	outPtr[8] = ptr[8];
            return out;
        }
        col_type &  operator[](size_type i)
        {
