...
namespace   CELL
{
    ...
    public:
        ...
        */
        ...
        {   
            load("data/model/Teapot01.sm.xml");
        ...
        */
        virtual void    onRender(const FrameEvent& /*evt*/,int width,int height)
        {
            ...
            _shader.begin();
            {
                ...
                _device.attributePointer(_shader._positionAttr, 3,  GL_FLOAT,false,sizeof(Vertex),&_arVertex[0].x);
                _device.attributePointer(_shader._uvAttr,       2,  GL_FLOAT,false,sizeof(Vertex),&_arVertex[0].u);
                _device.attributePointer(_shader._colorAttr,    4,  GL_FLOAT,false,sizeof(Vertex),&_arVertex[0].r);
