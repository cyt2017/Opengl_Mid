    ...
    public:
        ...
        */
        ...
        {   
            ...
            _textureBase    =   _device.createTexture2DFromFile("data/image/Basetex.tex");
            _textureNormal  =   _device.createTexture2DFromFile("data/image/stone_wall_normal_map.tex");
        ...
        */
        virtual void    onRender(const FrameEvent& /*evt*/,int width,int height)
        {
            ...
            _bumpShader.begin();
            {
                ...
                _device.bindTexture2D(&_textureNormal,1);

                _device.setUniform1i(_bumpShader.sBaseTex,0);
                _device.setUniform1i(_bumpShader.sNormalMap,1);
