...
namespace   CELL
{
    ...
    public:
        ...
        *   绘制函数
        */
        virtual void    onRender(Program_SpotLight& shader,CELL3RDCamera& camera)
        {
            ...
            matrix3 mvIT    =   mat3_cast(mv)._inverse();


            _device.setUniformMatrix4fv(shader.MVPMatrix,1,false,MVP.data());
            _device.setUniformMatrix4fv(shader.ModelView,1,false,mv.data());

            _device.setUniformMatrix3fv(shader.ModelViewIT,1,false,mvIT.data());
            ...
            _device.setUniform3fv(shader.LightPosition, 1, afLightPosition);
            _device.setUniform3fv(shader.LightDirection,1, afLightDirection);
            _device.setUniform3fv(shader.LightColor,    1, afLightColor);
